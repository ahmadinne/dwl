...
static const char *const autostart[] = {
		...
		"pipewire", NULL,
		"/bin/bash", "-c", "swaybg -i $HOME/Wallpaper/active/rn -m 'fill'", NULL, 
		"hyprlock", NULL,
		"hypridle", NULL,
...
static const char *lockscrn[] = { "hyprlock", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_BackSpace,  spawn,          {.v = lockscrn} },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_BackSpace,  spawn,          {.v = poweropt} },
	...
	{ MODKEY,                    XKB_KEY_underscore, incnmaster,     {.i = -1} },
